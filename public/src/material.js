...
class Sprite{
    ...
    setup(){
        ...
        this.aTextcooordLoc = gl.getAttribLocation(this.material.program, "a_texcoord"); 
        ...
        this.uObject = gl.getUniformLocation(this.material.program, "u_object");
    ...
    render(position, frames){
        if(this.isLoaded){
            ...
            let oMat = new Mtx3().transition(position.x, position.y);
            ...
            gl.bindBuffer(gl.ARRAY_BUFFER, this.tex_buff);
            gl.enableVertexAttribArray(this.aTextcooordLoc);
            gl.vertexAttribPointer(this.aTextcooordLoc, 2, gl.FLOAT, false, 0, 0);
            ...
            gl.uniformMatrix3fv(this.uWorldLoc, false, window.game.worldMatrix.getFloatArray());
            gl.uniformMatrix3fv(this.uObject, false, oMat.getFloatArray());
